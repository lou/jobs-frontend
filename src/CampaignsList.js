...
const CampaignsList = ({ campaigns, onCampaignClick }) => (
  <table className='table table-hover'>
    ...
    <tbody>
      {campaigns.map(campaign => (
        <CampaignRow key={campaign.id} campaign={campaign} onCampaignClick={onCampaignClick} />
      ))}
    </tbody>
  </table>
)
